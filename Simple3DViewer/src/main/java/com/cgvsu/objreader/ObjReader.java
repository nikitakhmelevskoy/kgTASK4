        ...
        if (scanner.hasNextLine()) {
            ...
            while (true) {
                ...
                switch (keyWord) {
                    ...
                    case OBJ_TEXTURE_TOKEN -> resultModel.getTextureVertices()
                            .add(parseTextureVertex(wordsInLine, lineInd));
                    ...
                    case OBJ_COMMENT_TOKEN -> {
                        if (writeInfo) {
                            System.out.println("Comment on the line: " + lineInd);
                        }
                    }
                    case OBJ_GROUP_TOKEN -> {
                        if (writeInfo) {
                            System.out.println("Group not supported: " + lineInd);
                        }
                    }
